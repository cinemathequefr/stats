var table = (function() {
  ...
  function init(_container) {
    ...
    d3TBody = d3
      ...
      .attr("class", "stats")
      .html(
        "<colgroup><col/><col/><col/><col/><col/></colgroup><thead><tr><th>Date</th><th>Salle</th><th>Id</th><th>Titre</th><th>Fréquentation</th></tr></thead>"
      )
  ...
  function update(_data) {
    ...
    d3TBody
      ...
      .each(function(d, i) {
        [
          function(elem, d) {
            elem.html(formatDateTime(d.date));
          },
          function(elem, d) {
            elem.html(d.salle.code);
          }, // Salle
          function(elem, d) {
            elem.html(d.idSeance);
          },
          function(elem, d) {
            elem.html(d.titre);
          },
    ...
    d3TBody
      ...
      .each(function(d, i) {
        [
          function(elem, d) {
            elem.attr("data-sort", d.date).html(formatDateTime(d.date));
          }, // Date
          function(elem, d) {
            elem.attr("data-sort", d.salle.id).html(d.salle.code);
          }, // Salle
          function(elem, d) {
            elem.html(d.idSeance);
          }, // IdSeance
